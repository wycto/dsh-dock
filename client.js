...
function AnimationView(props) {
  ...
  rows.push(
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dkan-note", children: "\u4EFB\u52A1\u8FD0\u884C\u72B6\u6001\uFF08\u8FDB\u884C\u4E2D\u4EFB\u52A1\u3001\u9636\u6BB5\u3001Token\u3001\u7B49\u5F85\u786E\u8BA4\u4E0E\u6700\u8FD1\u5B8C\u6210\uFF09\u5DF2\u72EC\u7ACB\u6210\u5DE6\u4FA7\u300C\u8FD0\u884C\u72B6\u6001\u300D\u83DC\u5355\uFF1B\u672C\u9875\u53EA\u8D1F\u8D23\u52A8\u6548\u3002" }, "hint")
  );
...
function AnimationStat(props) {
  ...
  const st = snap.status;
  if (snap.error) return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "dkan-err", children: "\u52A8\u753B\u72B6\u6001\u4E0D\u53EF\u7528\uFF08\u5BBF\u4E3B\u9700\u91CD\u542F\u52A0\u8F7D\u52A8\u753B\u8DEF\u7531\uFF09" });
  if (!st) return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: "\u7B49\u5F85\u52A8\u753B\u914D\u7F6E\u2026" });
  const cfg = st.config;
  if (!cfg) return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: "\u7B49\u5F85\u52A8\u753B\u914D\u7F6E\u2026" });
  if (!cfg.animationEnabled) return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: "\u52A8\u6548\u5DF2\u5173\u95ED \xB7 \u4EFB\u52A1\u8FDB\u884C\u4E2D\u4E0D\u663E\u793A\u52A8\u753B" });
  const mode = EFFECT_MODES.find((m) => m.id === cfg.effectMode) || EFFECT_MODES[0];
  const scale = Math.round((Number(cfg.robotScale) || 1.35) * 100);
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: "\u52A8\u6548\uFF1A" + mode.name + (cfg.effectMode === "robot" ? " \xB7 \u5927\u5C0F " + scale + "%" : "") });
}
var css2 = [
  // 顶部流光细线（3px，比首版更醒目）
...
function NotifyView(props) {
  ...
  rows.push(
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "dknt-note", children: "\u4EFB\u52A1\u8FD0\u884C\u72B6\u6001\uFF08\u8FDB\u884C\u4E2D\u4EFB\u52A1\u3001\u7B49\u5F85\u786E\u8BA4\u4E0E\u6700\u8FD1\u5B8C\u6210\uFF09\u5DF2\u72EC\u7ACB\u6210\u5DE6\u4FA7\u300C\u8FD0\u884C\u72B6\u6001\u300D\u83DC\u5355\uFF1B\u672C\u9875\u53EA\u8D1F\u8D23\u7ED3\u675F\u4E0E\u9700\u786E\u8BA4\u65F6\u7684\u63D0\u9192\u3002" }, "hint")
  );
...
function NotifyStat(props) {
  ...
  if (!cfg) return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: "\u7B49\u5F85\u901A\u77E5\u914D\u7F6E\u2026" });
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: (events.length ? "\u901A\u77E5\uFF1A" + events.join("/") : "\u901A\u77E5\u4E8B\u4EF6\u5168\u5173") + (extras.length ? " \xB7 " + extras.join("/") : "") + (push.length ? " \xB7 \u63A8\u9001\uFF1A" + push.join("/") : "") });
}
var css3 = [
...
// features/runstate/view.jsx
var import_react10 = require("react");
var import_jsx_runtime4 = require("react/jsx-runtime");
function rpcCall4(method, args) {
...
var runStateStore = {
  ...
  refresh() {
    ...
    this.snap = Object.assign({}, this.snap, { loading: true });
    this.emit();
    return rpcCall4("status").then((data) => {
      this.snap = { status: data, loading: false, error: null };
      this.emit();
    }).catch((e) => {
      this.snap = Object.assign({}, this.snap, { loading: false, error: e && e.message || String(e) });
...
function useRunState() {
  const [snap, setSnap] = (0, import_react10.useState)(runStateStore.snap);
  (0, import_react10.useEffect)(() => runStateStore.subscribe(() => setSnap(runStateStore.snap)), []);
  return snap;
}
...
function TaskCard(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dkrs-task", children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dkrs-task-head", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dkrs-task-title", title: t.title, children: t.title || "(\u65E0\u6807\u9898)" }),
      props.done ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dkrs-tag " + info.cls, children: info.label }) : waiting ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dkrs-tag warn", children: "\u7B49\u5F85\u786E\u8BA4" }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dkrs-tag on", children: phaseLabel2(t.phase) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dkrs-task-meta", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { children: (t.models && t.models.length ? t.models.join(", ") : "\u672A\u77E5") + (t.provider ? "\uFF08" + t.provider + "\uFF09" : "") }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { children: props.done ? fmtDur2(t.duration) : fmtClock2(t.elapsed) }),
      "turns" in t ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { children: "\u56DE\u5408 " + (t.turns || 0) + " \xB7 \u6B65\u9AA4 " + (t.steps || 0) + (t.toolCalls ? " \xB7 \u5DE5\u5177 " + t.toolCalls : "") }) : null,
      t.totalTokens ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { children: "\u21A7" + fmtCompact3(t.inputTokens) + " \u21A5" + fmtCompact3(t.outputTokens) }) : null,
      props.done && t.endTime ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { children: fmtTime3(t.endTime) }) : null
    ] }),
    waiting ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dkrs-task-wait", children: t.approvals.map((a, i) => (a && a.toolName ? a.toolName : "\u672A\u77E5\u5DE5\u5177") + (a && a.reason ? "\uFF1A" + truncate3(a.reason, 80) : "")).join("\uFF1B") }) : null,
    props.done && t.errorMessage ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dkrs-task-err", children: truncate3(t.errorMessage, 120) }) : null
  ] });
}
function RunStateView() {
  ...
  (0, import_react10.useEffect)(() => {
    ...
    const loop = async () => {
      ...
      timer = setTimeout(loop, s.error ? 15e3 : s.status && s.status.active && s.status.active.length > 0 ? 2e3 : 8e3);
    };
    loop();
    return () => {
      stopped = true;
  ...
  const sub = snap.error ? "\u72B6\u6001\u62C9\u53D6\u5931\u8D25\uFF1A" + snap.error : !st ? snap.loading ? "\u6B63\u5728\u62C9\u53D6\u4EFB\u52A1\u72B6\u6001\u2026" : "\u7B49\u5F85\u4EFB\u52A1\u72B6\u6001" : waitingCount > 0 ? waitingCount + " \u9879\u7B49\u5F85\u786E\u8BA4 \xB7 " + active.length + " \u4E2A\u4EFB\u52A1\u8FDB\u884C\u4E2D" : active.length > 0 ? active.length + " \u4E2A\u4EFB\u52A1\u8FDB\u884C\u4E2D" : recent.length > 0 ? "\u7A7A\u95F2 \xB7 \u663E\u793A\u6700\u8FD1\u5B8C\u6210" : "\u7A7A\u95F2 \xB7 \u6682\u65E0\u4EFB\u52A1\u8BB0\u5F55";
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dkrs-root", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dkrs-sec", children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dkrs-sec-head", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dkrs-sec-title", children: "\u8FD0\u884C\u72B6\u6001" }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dkrs-sec-sub", children: sub }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "button", className: "dkrs-refresh", onClick: () => runStateStore.refresh(), children: snap.loading ? "\u5237\u65B0\u4E2D\u2026" : "\u5237\u65B0" })
    ] }),
    waitingCount > 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dkrs-waitbanner", children: [
      "\u270B ",
      waitingCount,
      " \u9879\u7B49\u5F85\u786E\u8BA4\uFF1A\u4EFB\u52A1\u505C\u5728\u9700\u8981\u4F60\u6279\u51C6\u7684\u6B65\u9AA4\u4E0A\uFF0C\u8BF7\u5728\u4F1A\u8BDD\u91CC\u5904\u7406\u540E\u7EE7\u7EED\u3002"
    ] }) : null,
    active.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dkrs-tasks", children: active.map((t) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(TaskCard, { t }, t.sessionId)) }) : null,
    !snap.error && active.length === 0 && recent.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dkrs-note", children: "\u53D1\u8D77\u65B0\u4F1A\u8BDD\u4EFB\u52A1\u540E\uFF0C\u8FD9\u91CC\u4F1A\u663E\u793A\u8FDB\u884C\u4E2D\u4E0E\u6700\u8FD1\u5B8C\u6210\u7684\u4EFB\u52A1\uFF08\u52A8\u6548\u89C1\u5DE6\u4FA7\u300C\u4EFB\u52A1\u52A8\u753B\u300D\uFF0C\u63D0\u9192\u89C1\u300C\u4EFB\u52A1\u901A\u77E5\u300D\uFF09\u3002" }) : null,
    active.length === 0 && recent.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dkrs-note", children: "\u5F53\u524D\u6CA1\u6709\u8FDB\u884C\u4E2D\u7684\u4EFB\u52A1\u3002" }) : null,
    recent.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dkrs-done-title", children: "\u6700\u8FD1\u5B8C\u6210" }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dkrs-tasks dkrs-tasks-done", children: recent.map((t) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(TaskCard, { t, done: true }, t.sessionId + ":" + t.endTime)) })
    ] }) : null,
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dkrs-note dkrs-foot", children: "\u672C\u9875\u53EA\u8BFB\uFF1A\u6570\u636E\u6765\u81EA\u5BBF\u4E3B\u4FA7\u4F1A\u8BDD\u7EA7\u4EFB\u52A1\u8FFD\u8E2A\uFF0C\u4E0E\u300C\u4EFB\u52A1\u52A8\u753B\u300D\u300C\u4EFB\u52A1\u901A\u77E5\u300D\u5171\u7528\u540C\u4E00\u4EFD\uFF08\u4E09\u4E2A\u529F\u80FD\u53EF\u5404\u81EA\u542F\u505C\uFF09\u3002 \u52A8\u6548\u5728\u300C\u4EFB\u52A1\u52A8\u753B\u300D\uFF0C\u7ED3\u675F / \u9700\u786E\u8BA4\u63D0\u9192\u5728\u300C\u4EFB\u52A1\u901A\u77E5\u300D\u3002" })
  ] }) });
}
function RunStateStat(props) {
  const snap = useRunState();
  (0, import_react10.useEffect)(() => {
    if (!runStateStore.snap.status) runStateStore.refresh();
  }, []);
  const st = snap.status;
  if (snap.error) return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dkrs-err", children: "\u8FD0\u884C\u72B6\u6001\u4E0D\u53EF\u7528\uFF08\u5BBF\u4E3B\u9700\u91CD\u542F\u52A0\u8F7D\u8FD0\u884C\u72B6\u6001\u8DEF\u7531\uFF09" });
  if (!st) return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { children: "\u7B49\u5F85\u4EFB\u52A1\u72B6\u6001\u2026" });
  const active = st.active || [];
  const waiting = waitingOf(active);
  if (waiting > 0) return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "dkrs-warn", children: [
    "\u270B ",
    waiting,
    " \u9879\u7B49\u5F85\u786E\u8BA4 \xB7 ",
    active.length,
  ...
  if (active.length > 0) {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { children: active.length + " \u4E2A\u4EFB\u52A1\u8FDB\u884C\u4E2D \xB7 " + fmtDur2(Math.max(...active.map((x) => x.elapsed || 0))) });
  }
  const last = (st.recent || [])[0];
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { children: last ? "\u7A7A\u95F2 \xB7 \u6700\u8FD1\u5B8C\u6210 " + truncate3(last.title, 24) : "\u7A7A\u95F2 \xB7 \u6682\u65E0\u4EFB\u52A1\u8BB0\u5F55" });
}
var css4 = [
...
function useGameControls(stageRef, paused, onKeyDown, onKeyUp) {
  const pausedRef = (0, import_react11.useRef)(!!paused);
...
var TETRIS_GRID = (() => {
  ...
  for (let j = 0; j < 20; j += 1) {
    for (let i = 0; i < 10; i += 1) {
      parts.push(/* @__PURE__ */ (0, import_jsx_runtime5.jsx)("rect", { className: "dgame-tetris-pit", x: i * 100 + 7, y: j * 100 + 7, width: 86, height: 86, rx: 10 }, k++));
    }
  }
  for (let i = 1; i < 10; i += 1) parts.push(/* @__PURE__ */ (0, import_jsx_runtime5.jsx)("line", { x1: i * 100, y1: 0, x2: i * 100, y2: 2e3 }, k++));
  for (let j = 1; j < 20; j += 1) parts.push(/* @__PURE__ */ (0, import_jsx_runtime5.jsx)("line", { x1: 0, y1: j * 100, x2: 1e3, y2: j * 100 }, k++));
  return parts;
})();
function emptyBoard() {
...
function TetrisGame(props) {
  const [state, setState] = (0, import_react12.useState)(initial);
  const [manualPause, setManualPause] = (0, import_react12.useState)(false);
  const pausedRef = (0, import_react12.useRef)(!!(props && props.paused));
  pausedRef.current = !!(props && props.paused) || manualPause;
  const stageRef = (0, import_react12.useRef)(null);
  const act = (0, import_react12.useCallback)((action) => setState((s) => {
  ...
  const softRef = (0, import_react12.useRef)(null);
  const stateRef = (0, import_react12.useRef)(state);
  stateRef.current = state;
  const holdIdRef = (0, import_react12.useRef)(null);
  const stopSoft = (0, import_react12.useCallback)(() => {
    if (softRef.current) {
  ...
  const onKeyUp = (0, import_react12.useCallback)((event) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("section", { className: "dgame-game", "aria-label": "\u4FC4\u7F57\u65AF\u65B9\u5757", children: [
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "dgame-game-head", children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("h3", { children: "\u4FC4\u7F57\u65AF\u65B9\u5757" }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("p", { children: "\u62FC\u6EE1\u4E00\u884C\u5373\u6D88\u9664\uFF0C\u901F\u5EA6\u968F\u7B49\u7EA7\u52A0\u5FEB\uFF1B\u65B9\u5757\u5806\u5230\u9876\u7AEF\u5C31\u7ED3\u675F\u3002" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "dgame-score", children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("span", { children: [
          "\u5F97\u5206 ",
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("strong", { children: state.score })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("span", { children: [
          "\u7B49\u7EA7 ",
          state.level,
    ...
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "dgame-tetris", children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "dgame-tetris-board", ref: stageRef, tabIndex: 0, onKeyDown, onKeyUp, onBlur: stopSoft, onClick: () => focusStage(stageRef), "aria-label": "\u4FC4\u7F57\u65AF\u65B9\u5757\u6E38\u620F\u533A\u57DF\uFF0C\u4F7F\u7528\u65B9\u5411\u952E\u4E0E\u7A7A\u683C\u63A7\u5236", children: [
        display.map((row, rr) => row.map((cell, cc) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("i", { className: "dgame-tetris-cell", style: cell ? { background: cell, boxShadow: "0 0 8px " + cell + "aa, inset 0 0 4px rgba(255,255,255,.5)" } : void 0 }, rr + "-" + cc))),
        state.over ? /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "dgame-over", children: [
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("strong", { children: "\u65B9\u5757\u5806\u5230\u9876\u4E86" }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("button", { type: "button", onClick: () => setState(initial()), children: "\u518D\u6765\u4E00\u5C40" })
        ] }) : /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("svg", { className: "dgame-tetris-lines", viewBox: "0 0 1000 2000", preserveAspectRatio: "none", "aria-hidden": "true", children: TETRIS_GRID }),
        !state.over && (props.paused || manualPause) ? /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "dgame-over", children: [
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("strong", { children: "\u5DF2\u6682\u505C" }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("button", { type: "button", onClick: () => setManualPause(false), children: "\u7EE7\u7EED\uFF08P\uFF09" })
        ] }) : null
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "dgame-tetris-side", children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "dgame-tetris-next", children: [
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { children: "\u4E0B\u4E00\u4E2A" }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "dgame-tetris-nextbox", children: nextMat.map((row, r) => row.map((cell, c) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("i", { className: "dgame-tetris-cell", style: cell ? { background: PIECES[nextType].color } : void 0 }, r + "-" + c))) })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "dgame-tetris-keys", children: [
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("b", { children: "\u64CD\u4F5C" }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { children: "\u2190/\u2192 \u79FB\u52A8 \xB7 \u2193 \u5FEB\u901F\u4E0B\u6ED1 \xB7 \u2191/X \u65CB\u8F6C \xB7 Z \u53CD\u5411 \xB7 \u7A7A\u683C \u76F4\u843D \xB7 P \u6682\u505C \xB7 R \u91CD\u5F00" })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "dgame-controls", children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("button", { type: "button", "aria-label": "\u5DE6\u79FB", onClick: () => act("left"), children: "\u2190 \u5DE6\u79FB" }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { children: "\u65B9\u5411\u952E / X\u3001Z\u3001\u7A7A\u683C\u3001P" }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("button", { type: "button", "aria-label": "\u53F3\u79FB", onClick: () => act("right"), children: [
        "\u53F3\u79FB ",
        "->"
      ] })
    ] })
...
function TetrisPreview() {
  ...
  const isFall = (r) => r === 1;
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "dgcov-prev dgcov-prev-tetris", "aria-hidden": "true", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "dgp-tet-grid", children: ROWS3.flatMap((row, r) => row.split("").map((ch, c) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("i", { className: COLORS2[ch] ? "c" + COLORS2[ch] + (isFall(r) ? " fall" : "") : "" }, r + "-" + c))) }) });
}
...
function SokobanGame(props) {
  const [level, setLevel] = (0, import_react13.useState)(0);
  const [state, setState] = (0, import_react13.useState)(() => makeInitial(0));
  const stageRef = (0, import_react13.useRef)(null);
  const levelRef = (0, import_react13.useRef)(level);
  levelRef.current = level;
  const move = (0, import_react13.useCallback)((dr, dc) => setState((s) => step(s, dr, dc)), []);
  const prevWon = (0, import_react13.useRef)(false);
  (0, import_react13.useEffect)(() => {
    if (state.wonNew && !prevWon.current) playSfx("win");
    prevWon.current = state.wonNew;
  }, [state.wonNew]);
  const nextLevel = (0, import_react13.useCallback)(() => {
    const n = (levelRef.current + 1) % LEVELS.length;
    setLevel(n);
    setState(makeInitial(n));
  }, []);
  const pickLevel = (0, import_react13.useCallback)((i) => {
    setLevel(i);
    setState(makeInitial(i));
  }, []);
  const reset = (0, import_react13.useCallback)(() => setState(makeInitial(levelRef.current)), []);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("section", { className: "dgame-game", "aria-label": "\u63A8\u7BB1\u5B50", children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dgame-game-head", children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("h3", { children: "\u63A8\u7BB1\u5B50" }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { children: "\u7528\u65B9\u5411\u952E\u628A\u7BB1\u5B50\u63A8\u5230\u76EE\u6807\u683C\u5B50\u4E0A\uFF1B\u5168\u90E8\u5230\u4F4D\u5373\u8FC7\u5173\uFF08U \u64A4\u9500\u3001R \u91CD\u7F6E\uFF09\u3002" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dgame-score", children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { children: [
          "\u6B65\u6570 ",
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("strong", { children: state.moves })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { children: [
          "\u63A8\u7BB1 ",
          state.pushes
    ...
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dgame-sokoban-levels", role: "tablist", "aria-label": "\u9009\u62E9\u5173\u5361", children: [
      LEVELS.map((_, i) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { type: "button", role: "tab", "aria-selected": i === level, className: i === level ? "on" : "", onClick: () => pickLevel(i), children: i + 1 }) }, i)),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { type: "button", onClick: () => setState((s) => undo(s)), children: "\u64A4\u9500" }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { type: "button", onClick: reset, children: "\u91CD\u7F6E" })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dgame-sokoban-stage", ref: stageRef, tabIndex: 0, onKeyDown, onClick: () => focusStage(stageRef), style: { width, gridTemplateColumns: "repeat(" + cols + ",1fr)", gridTemplateRows: "repeat(" + rows + ",1fr)", aspectRatio: cols + " / " + rows }, "aria-label": "\u63A8\u7BB1\u5B50\u6E38\u620F\u533A\u57DF\uFF0C\u4F7F\u7528\u65B9\u5411\u952E\u79FB\u52A8\uFF0CU \u64A4\u9500\uFF0CR \u91CD\u7F6E", children: [
      grid.map((row, r) => row.map((ch, c) => {
        ...
        if (ch === "$" || ch === "*") cls += " box";
        if (ch === "@" || ch === "+") cls += " player";
        return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("i", { className: cls, "aria-hidden": "true" }, r + "-" + c);
      })),
      state.wonNew ? /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dgame-over", children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("strong", { children: [
          "\u5168\u641E\u5B9A\uFF01\u7B2C ",
          level + 1,
          " \u5173\u901A\u8FC7"
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { type: "button", onClick: nextLevel, children: level + 1 < LEVELS.length ? "\u4E0B\u4E00\u5173" : "\u91CD\u65B0\u5F00\u59CB" })
      ] }) : null
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dgame-controls", children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { type: "button", "aria-label": "\u5411\u4E0A", onClick: () => move(-1, 0), children: "\u2191" }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { children: "\u65B9\u5411\u952E / WASD \xB7 U \u64A4\u9500 \xB7 R \u91CD\u7F6E" }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { type: "button", "aria-label": "\u5411\u4E0B", onClick: () => move(1, 0), children: "\u2193" })
    ] })
  ] });
}
function SokobanPreview() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "dgcov-prev dgcov-prev-soko", "aria-hidden": "true", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "dgp-soko-grid", children: ROWS3.flatMap((row, r) => row.split("").map((ch, c) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("i", { className: "dgp-soko-" + cls[ch] }, r + "-" + c))) }) });
}
...
var GOMOKU_LINES = (() => {
  const P = (n) => n * 100 + 50;
  const parts = [/* @__PURE__ */ (0, import_jsx_runtime7.jsx)("rect", { x: P(0), y: P(0), width: 1400, height: 1400, strokeWidth: 6.5, fill: "none" }, "frame")];
  let k = 0;
  for (let i = 1; i <= 13; i += 1) {
    parts.push(/* @__PURE__ */ (0, import_jsx_runtime7.jsx)("line", { x1: P(i), y1: P(0), x2: P(i), y2: P(14) }, k++));
    parts.push(/* @__PURE__ */ (0, import_jsx_runtime7.jsx)("line", { x1: P(0), y1: P(i), x2: P(14), y2: P(i) }, k++));
  }
  for (const [r, c] of [[3, 3], [3, 11], [7, 7], [11, 3], [11, 11]]) {
    parts.push(/* @__PURE__ */ (0, import_jsx_runtime7.jsx)("circle", { className: "dgame-gomoku-star", cx: P(c), cy: P(r), r: 15 }, k++));
  }
  return parts;
})();
var SIZE = 15;
...
function GomokuGame(props) {
  const [board, setBoard] = (0, import_react14.useState)(emptyBoard2);
  const [turn, setTurn] = (0, import_react14.useState)("b");
  const [winner, setWinner] = (0, import_react14.useState)(null);
  const [winCells, setWinCells] = (0, import_react14.useState)(null);
  const [showResult, setShowResult] = (0, import_react14.useState)(false);
  ...
  const winRef = (0, import_react14.useRef)(winner);
  winRef.current = winner;
  const finish = (0, import_react14.useCallback)((b, r, c, color) => {
  ...
  const place = (0, import_react14.useCallback)((r, c, color) => {
  ...
  const onCell = (0, import_react14.useCallback)((r, c) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("section", { className: "dgame-game", "aria-label": "\u4E94\u5B50\u68CB", children: [
    /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "dgame-game-head", children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("h3", { children: "\u4E94\u5B50\u68CB" }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("p", { children: "\u4F60\u6267\u9ED1\u5148\u624B\uFF0CAI \u6267\u767D\uFF1B\u5148\u5728\u6A2A\u7AD6\u659C\u4EFB\u4E00\u7EBF\u8FDE\u6210\u4E94\u5B50\u8005\u80DC\u3002" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "dgame-score", children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { children: "\u56DE\u5408" }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("strong", { className: "dg-gomoku-status", children: statusText }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("button", { type: "button", onClick: undo2, children: "\u64A4\u9500" }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("button", { type: "button", onClick: reset, children: "\u91CD\u5F00" })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "dgame-gomoku-board", ref: stageRef, tabIndex: 0, onKeyDown, onClick: () => focusStage(stageRef), role: "grid", "aria-label": "\u5341\u4E94\u8DEF\u4E94\u5B50\u68CB\u68CB\u76D8", children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("svg", { className: "dgame-gomoku-lines", viewBox: "0 0 1500 1500", preserveAspectRatio: "none", "aria-hidden": "true", children: GOMOKU_LINES }),
      board.map((row, r) => row.map((cell, c) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
          "button",
          {
            ...
            children: cell ? /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("i", { className: "dgame-gomoku-stone " + (cell === "b" ? "black" : "white") }) : null
          },
          r + "-" + c
        );
      })),
      winner && showResult ? /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "dgame-gomoku-result", role: "status", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "dgame-gomoku-result-card " + winner, children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "dgame-gomoku-result-icon", "aria-hidden": "true", children: winner === "b" ? "\u{1F389}" : winner === "w" ? "\u{1F916}" : "\u{1F91D}" }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("strong", { children: winner === "b" ? "\u4F60\u8D62\u4E86\uFF01" : winner === "w" ? "AI \u8D62\u4E86" : "\u548C\u68CB" }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("p", { children: winner === "b" ? "\u4E94\u5B50\u8FDE\u73E0\uFF0C\u6F02\u4EAE\uFF01" : winner === "w" ? "\u518D\u63A5\u518D\u5389\uFF0C\u5377\u571F\u91CD\u6765\u3002" : "\u68CB\u76D8\u5DF2\u6EE1\uFF0C\u5E73\u5206\u79CB\u8272\u3002" }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "dgame-gomoku-result-actions", children: [
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("button", { type: "button", onClick: (e) => {
            e.stopPropagation();
            setShowResult(false);
          }, children: "\u67E5\u770B\u68CB\u76D8" }),
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("button", { type: "button", onClick: (e) => {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "dgame-controls", children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("button", { type: "button", onClick: undo2, children: "\u64A4\u9500" }),
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { children: statusText }),
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("button", { type: "button", onClick: reset, children: "\u91CD\u5F00" })
    ] })
  ] });
}
function GomokuPreview() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "dgcov-prev dgcov-prev-gomoku", "aria-hidden": "true", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("svg", { viewBox: "0 0 900 900", preserveAspectRatio: "xMidYMid slice", children: [
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("rect", { x: P(0), y: P(0), width: 800, height: 800, fill: "none", strokeWidth: 11 }),
    [1, 2, 3, 4, 5, 6, 7].map((i) => [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("line", { x1: P(i), y1: P(0), x2: P(i), y2: P(8) }, "v" + i),
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("line", { x1: P(0), y1: P(i), x2: P(8), y2: P(i) }, "h" + i)
    ]),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("circle", { className: "dgp-star", cx: P(4), cy: P(4), r: 16 }),
    stones.map(([r, c, col], i) => /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("circle", { className: "dgp-stone-" + col, cx: P(c), cy: P(r), r: 40 }, i))
  ] }) });
}
...
var XIANGQI_LINES = (() => {
  ...
  const parts = [];
  let k = 0;
  parts.push(/* @__PURE__ */ (0, import_jsx_runtime8.jsx)("rect", { x: P(0), y: P(0), width: 800, height: 900, strokeWidth: 7, fill: "none" }, "frame"));
  for (let r = 1; r <= 8; r += 1) parts.push(/* @__PURE__ */ (0, import_jsx_runtime8.jsx)("line", { x1: P(0), y1: P(r), x2: P(8), y2: P(r) }, k++));
  for (let c = 1; c <= 7; c += 1) {
    parts.push(/* @__PURE__ */ (0, import_jsx_runtime8.jsx)("line", { x1: P(c), y1: P(0), x2: P(c), y2: P(4) }, k++));
    parts.push(/* @__PURE__ */ (0, import_jsx_runtime8.jsx)("line", { x1: P(c), y1: P(5), x2: P(c), y2: P(9) }, k++));
  }
  parts.push(/* @__PURE__ */ (0, import_jsx_runtime8.jsx)("path", { d: `M${P(3)} ${P(0)}L${P(5)} ${P(2)}M${P(5)} ${P(0)}L${P(3)} ${P(2)}M${P(3)} ${P(7)}L${P(5)} ${P(9)}M${P(5)} ${P(7)}L${P(3)} ${P(9)}` }, k++));
  const t = 14, o = 16;
  ...
  for (const [c, r] of marks) {
    ...
    parts.push(/* @__PURE__ */ (0, import_jsx_runtime8.jsx)("path", { className: "dgame-xiangqi-mark", strokeWidth: 2.6, d: seg.join("") }, k++));
  }
  return parts;
})();
...
function XiangqiGame(props) {
  const [board, setBoard] = (0, import_react15.useState)(initialBoard);
  const [turn, setTurn] = (0, import_react15.useState)("r");
  const [sel, setSel] = (0, import_react15.useState)(null);
  const [targets, setTargets] = (0, import_react15.useState)([]);
  const [over, setOver] = (0, import_react15.useState)(null);
  const [check, setCheck] = (0, import_react15.useState)(false);
  const [last, setLast] = (0, import_react15.useState)(null);
  const [lastMove, setLastMove] = (0, import_react15.useState)(null);
  const [moveLog, setMoveLog] = (0, import_react15.useState)([]);
  const [moving, setMoving] = (0, import_react15.useState)(null);
  const [thinking, setThinking] = (0, import_react15.useState)(false);
  const [history, setHistory] = (0, import_react15.useState)([]);
  const [repKeys, setRepKeys] = (0, import_react15.useState)(() => [posKey(initialBoard())]);
  const pushKey = (0, import_react15.useCallback)((b) => setRepKeys((ks) => ks[ks.length - 1] === posKey(b) ? ks : ks.concat(posKey(b))), []);
  const stageRef = (0, import_react15.useRef)(null);
  const boardRef = (0, import_react15.useRef)(board);
  boardRef.current = board;
  const turnRef = (0, import_react15.useRef)(turn);
  turnRef.current = turn;
  const overRef = (0, import_react15.useRef)(over);
  overRef.current = over;
  const thinkingRef = (0, import_react15.useRef)(thinking);
  thinkingRef.current = thinking;
  const historyRef = (0, import_react15.useRef)(history);
  historyRef.current = history;
  const movingRef = (0, import_react15.useRef)(false);
  const pendingRef = (0, import_react15.useRef)(null);
  const animTimerRef = (0, import_react15.useRef)(null);
  const animateMove = (0, import_react15.useCallback)((b, fr, fc, tr, tc, after) => {
  ...
  const restart = (0, import_react15.useCallback)(() => {
  ...
  const undo2 = (0, import_react15.useCallback)(() => {
  ...
  const moveRed = (0, import_react15.useCallback)((tr, tc) => {
  ...
  const select = (0, import_react15.useCallback)((r, c) => {
  ...
  const prevCheck = (0, import_react15.useRef)(false);
  (0, import_react15.useEffect)(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("section", { className: "dgame-game", "aria-label": "\u8C61\u68CB", children: [
    /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "dgame-game-head", children: [
      /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("h3", { children: "\u4E2D\u56FD\u8C61\u68CB" }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("p", { children: "\u4F60\u6267\u7EA2\u5148\u884C\uFF0CAI \u6267\u9ED1\uFF1B\u5403\u6389\u5BF9\u65B9\u5C06/\u5E05\u5373\u80DC\u3002\u70B9\u51FB\u9009\u4E2D\u7EA2\u5B50\uFF0C\u518D\u70B9\u9AD8\u4EAE\u843D\u70B9\u8D70\u68CB\u3002" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "dgame-score", children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { children: "\u5F53\u524D" }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("strong", { className: "dg-gomoku-status", children: status }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("button", { type: "button", onClick: undo2, children: "\u64A4\u9500" }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("button", { type: "button", onClick: restart, children: "\u91CD\u5F00" })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "dgame-xiangqi-board", ref: stageRef, tabIndex: 0, onKeyDown, onClick: () => focusStage(stageRef), role: "grid", "aria-label": "\u4E2D\u56FD\u8C61\u68CB\u68CB\u76D8", children: [
      /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("svg", { className: "dgame-xiangqi-lines", viewBox: "0 0 900 1000", preserveAspectRatio: "none", "aria-hidden": "true", children: [
        XIANGQI_LINES,
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("text", { className: "dgame-xiangqi-rivertext", x: 230, y: 505, children: "\u695A \u6CB3" }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("text", { className: "dgame-xiangqi-rivertext", x: 670, y: 505, children: "\u6F22 \u754C" })
      ] }),
      board.map((row, r) => row.map((p, c) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
          "button",
          {
            ...
            children: p && !isFlyFrom ? /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "dgame-xiangqi-pc " + p.c + (isDying ? " dying" : ""), children: pieceChar(p) }) : !p && isTargetMark ? /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "dgame-xiangqi-dot", "aria-hidden": "true" }) : null
          },
          r + "-" + c
        );
      })),
      moving ? /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
        "span",
        {
    ...
    moveLog.length ? /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "dgame-xiangqi-log", role: "status", "aria-live": "polite", children: moveLog.slice(-4).map((m, i) => /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: m.side, children: m.text }, moveLog.length - 4 + i)) }) : null,
...
function XiangqiPreview() {
  const P = (n) => n * 100 + 50;
  const pc = (c, r, ch, col) => [
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("circle", { cx: P(c), cy: P(r), r: 44, className: "dgp-xq-pc-" + col }, "pc" + c + r),
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("text", { x: P(c), y: P(r) + 2, className: "dgp-xq-tx-" + col, children: ch }, "tx" + c + r)
  ];
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "dgcov-prev dgcov-prev-xiangqi", "aria-hidden": "true", children: /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("svg", { viewBox: "0 0 900 1000", preserveAspectRatio: "xMidYMid slice", children: [
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("rect", { x: P(0), y: P(0), width: 800, height: 900, fill: "none", strokeWidth: 11 }),
    [1, 2, 3, 4, 5, 6, 7, 8].map((r) => /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("line", { x1: P(0), y1: P(r), x2: P(8), y2: P(r) }, "h" + r)),
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("line", { x1: P(0), y1: P(0), x2: P(0), y2: P(9) }),
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("line", { x1: P(8), y1: P(0), x2: P(8), y2: P(9) }),
    [1, 2, 3, 4, 5, 6, 7].map((c) => [
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("line", { x1: P(c), y1: P(0), x2: P(c), y2: P(4) }, "vt" + c),
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("line", { x1: P(c), y1: P(5), x2: P(c), y2: P(9) }, "vb" + c)
    ]),
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("path", { d: `M${P(3)} ${P(0)}L${P(5)} ${P(2)}M${P(5)} ${P(0)}L${P(3)} ${P(2)}M${P(3)} ${P(7)}L${P(5)} ${P(9)}M${P(5)} ${P(7)}L${P(3)} ${P(9)}` }),
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("text", { className: "dgp-xq-river", x: 235, y: 500, children: "\u695A\u6CB3" }),
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("text", { className: "dgp-xq-river", x: 665, y: 500, children: "\u6F22\u754C" }),
    pc(4, 0, "\u5C07", "b"),
    pc(1, 2, "\u70AE", "b"),
    pc(5, 3, "\u5352", "b"),
    pc(3, 6, "\u5175", "r"),
...
function SnakeGame(props) {
  const [state, setState] = (0, import_react16.useState)(initial2);
  const [paused, setPaused] = (0, import_react16.useState)(false);
  const [speedMode, setSpeedMode] = (0, import_react16.useState)(loadSpeedMode);
  const stageRef = (0, import_react16.useRef)(null);
  const dirRef = (0, import_react16.useRef)(state.dir);
  const overRef = (0, import_react16.useRef)(state.over);
  overRef.current = state.over;
  const pausedRef = (0, import_react16.useRef)(!!(props && props.paused) || paused);
  ...
  const begin = (0, import_react16.useCallback)(() => {
    setState((s) => s.started || s.over ? s : Object.assign({}, s, { started: true }));
  }, []);
  const changeDir = (0, import_react16.useCallback)((nv) => {
  ...
  const pickSpeed = (0, import_react16.useCallback)((m) => {
    setSpeedMode(m);
    try {
  ...
  for (let r = 0; r < SIZE2; r += 1) {
    for (let c = 0; c < SIZE2; c += 1) {
      ...
      if (isFood) cls += " food";
      cells.push(/* @__PURE__ */ (0, import_jsx_runtime9.jsx)("i", { className: cls, "aria-hidden": "true" }, r + "-" + c));
    }
  }
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("section", { className: "dgame-game", "aria-label": "\u8D2A\u5403\u86C7", children: [
    /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "dgame-game-head", children: [
      /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("h3", { children: "\u8D2A\u5403\u86C7" }),
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("p", { children: "\u56DE\u8F66\u5F00\u59CB/\u6682\u505C\uFF0C\u65B9\u5411\u952E\u63A7\u5236\u79FB\u52A8\uFF1B\u5403\u5230\u98DF\u7269\u53D8\u957F\u5E76\u7F13\u6162\u63D0\u901F\uFF0C\u649E\u5899\u6216\u54AC\u5230\u81EA\u5DF1\u5C31\u7ED3\u675F\u3002" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "dgame-score", children: [
        /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("span", { children: [
          "\u957F\u5EA6 ",
          /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("strong", { children: state.score + 3 })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("span", { children: [
          "\u5F97\u5206 ",
          state.score
    ...
    /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "dgame-snake-speeds", role: "radiogroup", "aria-label": "\u6E38\u620F\u901F\u5EA6", children: [
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { children: "\u901F\u5EA6" }),
      Object.entries(SPEED_MODES).map(([m, cfg]) => /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("button", { type: "button", role: "radio", "aria-checked": speedMode === m, className: speedMode === m ? "on" : "", onClick: () => pickSpeed(m), children: cfg.label }, m))
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "dgame-snake-stage", ref: stageRef, tabIndex: 0, onKeyDown, onClick: () => focusStage(stageRef), "aria-label": "\u8D2A\u5403\u86C7\u6E38\u620F\u533A\u57DF\uFF0C\u4F7F\u7528\u65B9\u5411\u952E\u63A7\u5236\u79FB\u52A8\uFF0C\u56DE\u8F66\u5F00\u59CB", children: [
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "dgame-snake-grid", children: cells }),
      state.over ? /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "dgame-over", children: [
        /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("strong", { children: [
          "\u649E\u4E0A\u4E86 \xB7 \u5F97 ",
          state.score,
          " \u5206"
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("button", { type: "button", onClick: start, children: "\u91CD\u65B0\u5F00\u59CB" })
      ] }) : null,
      !state.started && !state.over ? /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "dgame-over", children: [
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("strong", { children: "\u6309 Enter \u6216\u65B9\u5411\u952E\u5F00\u59CB" }),
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("button", { type: "button", onClick: start, children: "\u5F00\u59CB\u6E38\u620F" })
      ] }) : null,
      state.started && !state.over && pausedRef.current ? /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "dgame-over", children: [
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("strong", { children: "\u5DF2\u6682\u505C" }),
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("button", { type: "button", onClick: () => setPaused(false), children: "\u7EE7\u7EED\uFF08P\uFF09" })
      ] }) : null
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "dgame-controls", children: [
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("button", { type: "button", "aria-label": "\u5411\u4E0A", onClick: () => changeDir([-1, 0]), children: "\u2191" }),
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { children: "\u65B9\u5411\u952E / WASD \xB7 \u56DE\u8F66 \u5F00\u59CB/\u6682\u505C \xB7 R \u91CD\u5F00" }),
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("button", { type: "button", "aria-label": "\u5411\u4E0B", onClick: () => changeDir([1, 0]), children: "\u2193" })
    ] })
  ] });
}
function SnakePreview() {
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("span", { className: "dgcov-prev dgcov-prev-snake", "aria-hidden": "true", children: [
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("i", { style: { left: "12%", top: "62%" } }),
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("i", { style: { left: "24%", top: "62%" } }),
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("i", { style: { left: "36%", top: "62%" } }),
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("i", { style: { left: "48%", top: "62%" } }),
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("i", { style: { left: "60%", top: "62%" } }),
...
function BreakoutGame(props) {
  ...
  const [score, setScore] = (0, import_react17.useState)(0);
  const [lives, setLives] = (0, import_react17.useState)(3);
  const [level, setLevel] = (0, import_react17.useState)(1);
  ...
  const scoreRef = (0, import_react17.useRef)(0);
  scoreRef.current = score;
  const statusRef = (0, import_react17.useRef)("play");
  statusRef.current = status;
  const livesRef = (0, import_react17.useRef)(3);
  livesRef.current = lives;
  const start = (0, import_react17.useCallback)((lvl) => {
  ...
  const launchBall = (0, import_react17.useCallback)(() => {
  ...
  const resetBall = (0, import_react17.useCallback)(() => {
    const g = game.current;
    if (g) {
      g.ball.x = W / 2;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("section", { className: "dgame-game", "aria-label": "\u6253\u7816\u5757", children: [
    /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "dgame-game-head", children: [
      /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("h3", { children: "\u6253\u7816\u5757" }),
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("p", { children: "\u79FB\u52A8\u6321\u677F\u53CD\u5F39\u5C0F\u7403\uFF0C\u51FB\u788E\u6240\u6709\u7816\u5757\uFF1B\u7403\u843D\u5230\u5E95\u90E8\u6263\u4E00\u6761\u547D\u3002" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "dgame-score", children: [
        /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("span", { children: [
          "\u5F97\u5206 ",
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("strong", { children: score })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("span", { children: [
          "\u547D ",
          lives,
    ...
    /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "dgame-breakout", children: [
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("canvas", { ref: canvasRef, width: W, height: H, tabIndex: 0, onKeyDown, onKeyUp, onPointerMove, onClick: (e) => {
        focusStage(canvasRef);
        launchBall();
      }, className: "dgame-breakout-canvas", "aria-label": "\u6253\u7816\u5757\u6E38\u620F\u533A\u57DF\uFF0C\u5DE6\u53F3\u65B9\u5411\u952E\u6216\u9F20\u6807\u79FB\u52A8\u6321\u677F\uFF0C\u7A7A\u683C\u6216\u70B9\u51FB\u53D1\u7403" }),
      status === "win" ? /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "dgame-over", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "dgame-controls", children: [
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("button", { type: "button", "aria-label": "\u5411\u5DE6\u79FB\u52A8", onClick: () => {
        keys.current.left = false;
        game.current && (game.current.paddle.x = Math.max(0, game.current.paddle.x - 12));
      }, children: "\u2190 \u5DE6\u79FB" }),
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { children: "\u2190/\u2192 \u6216\u9F20\u6807\u79FB\u52A8 \xB7 \u7A7A\u683C/\u70B9\u51FB\u53D1\u7403" }),
      /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("button", { type: "button", "aria-label": "\u5411\u53F3\u79FB\u52A8", onClick: () => {
...
function BreakoutPreview() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("span", { className: "dgcov-prev dgcov-prev-breakout", "aria-hidden": "true", children: [
    Array.from({ length: 12 }, (_, i) => {
      const row = Math.floor(i / 6), c = i % 6;
      return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("i", { style: { left: 5 + c * 15 + "%", top: 10 + row * 12 + "%", background: cols[i % cols.length] } }, i);
    }),
...
function RacerGame(props) {
  ...
  const game = (0, import_react18.useRef)(null);
  const keys = (0, import_react18.useRef)({});
  ...
  const launch = (0, import_react18.useCallback)(() => {
    reset();
    setStatus("play");
  }, [reset]);
  (0, import_react18.useEffect)(() => {
  ...
  useGameControls(canvasRef, pausedRef.current, onKeyDown, onKeyUp);
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("section", { className: "dgame-game", "aria-label": "\u6781\u901F\u8D5B\u8F66", children: [
    /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "dgame-game-head", children: [
      /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("h3", { children: "\u6781\u901F\u8D5B\u8F66" }),
        /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("p", { children: "\u5DE6\u53F3\u79FB\u52A8\u907F\u5F00\u8FCE\u9762\u6765\u8F66\u3001\u6536\u96C6\u91D1\u5E01\uFF0C\u8D8A\u5F00\u8D8A\u5FEB\uFF1B\u649E\u8F66\u5373\u7ED3\u675F\u3002\u8DDD\u79BB\u4E0E\u91D1\u5E01\u5B9E\u65F6\u663E\u793A\u5728\u6E38\u620F\u753B\u9762\u5DE6\u4E0A/\u53F3\u4E0A\u3002" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "dgame-score", children: [
        /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { children: "\u64CD\u4F5C" }),
        /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { children: "\u2190/\u2192 \u6216\u9F20\u6807" })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "dgame-racer", children: [
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("canvas", { ref: canvasRef, width: W2, height: H2, tabIndex: 0, onKeyDown, onKeyUp, onPointerMove, onClick: () => focusStage(canvasRef), className: "dgame-racer-canvas", "aria-label": "\u6781\u901F\u8D5B\u8F66\u6E38\u620F\u533A\u57DF\uFF0C\u5DE6\u53F3\u65B9\u5411\u952E\u6216\u9F20\u6807\u63A7\u5236\u65B9\u5411" }),
      status === "over" ? /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "dgame-over", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("button", { type: "button", onClick: launch, children: "\u91CD\u65B0\u51FA\u53D1" })
      ] }) : null
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "dgame-controls", children: [
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("button", { type: "button", "aria-label": "\u5411\u5DE6", onClick: () => {
        keys.current.left = false;
        if (game.current) game.current.player.x = Math.max(ROAD_X + 2, game.current.player.x - 14);
      }, children: "\u2190 \u5DE6\u79FB" }),
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { children: "\u2190/\u2192 \u6216\u9F20\u6807\u79FB\u52A8 \xB7 R \u91CD\u5F00" }),
      /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("button", { type: "button", "aria-label": "\u5411\u53F3", onClick: () => {
        keys.current.right = false;
...
function RacerPreview() {
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("span", { className: "dgcov-prev dgcov-prev-racer", "aria-hidden": "true", children: [
    /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("i", { style: { left: "20%", top: "8%" } }),
    /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("i", { style: { left: "55%", top: "22%" } }),
    /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("i", { style: { left: "20%", top: "42%" } }),
    /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("i", { style: { left: "64%", top: "58%" } }),
    /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("i", { style: { left: "38%", top: "74%" } }),
...
function TankGame(props) {
  const [snap, setSnap] = (0, import_react19.useState)(initialState);
  const [status, setStatus] = (0, import_react19.useState)("play");
  const snapRef = (0, import_react19.useRef)(snap);
  snapRef.current = snap;
  const keys = (0, import_react19.useRef)({ dir: null, shoot: false });
  const pausedRef = (0, import_react19.useRef)(!!(props && props.paused));
  pausedRef.current = !!(props && props.paused);
  const statusRef = (0, import_react19.useRef)("play");
  statusRef.current = status;
  const boardRef = (0, import_react19.useRef)(null);
  const start = (0, import_react19.useCallback)(() => {
    setSnap(initialState());
    setStatus("play");
    statusRef.current = "play";
  }, []);
  const nextLvl = (0, import_react19.useCallback)(() => {
  ...
  const onKeyUp = (0, import_react19.useCallback)((event) => {
    const map = { ArrowUp: "up", ArrowDown: "down", ArrowLeft: "left", ArrowRight: "right", w: "up", s: "down", a: "left", d: "right", W: "up", S: "down", A: "left", D: "right" };
    const dir = map[event.key];
  ...
  for (let r = 0; r < GRID; r += 1) {
    for (let c = 0; c < GRID; c += 1) {
      ...
      if (playerPos && playerPos.r === r && playerPos.c === c) {
        cls += " pw";
        inner = /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("i", { className: "dgame-tank-body pw", style: { transform: "rotate(" + DIR_ANGLE[player.dir] + "deg)" } });
      } else if (enemyMap[key]) {
        const e = enemyMap[key];
        cls += " en";
        inner = /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("i", { className: "dgame-tank-body en", style: { background: ENEMY_COLORS[(e.r + e.c) % ENEMY_COLORS.length], transform: "rotate(" + DIR_ANGLE[e.dir] + "deg)" } });
      }
      if (bullets && bulletMap[key]) cls += " bullet";
      cells.push(/* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("span", { className: cls, children: [
        inner,
        bulletMap[key] ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("i", { className: "dgame-tank-bullet", "aria-hidden": "true" }) : null,
        grid[r][c] === BASE ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("b", { className: "dgame-tank-flag", "aria-hidden": "true", children: "\u2691" }) : null
      ] }, key));
    }
  }
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("section", { className: "dgame-game", "aria-label": "\u5766\u514B\u5927\u6218", children: [
    /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "dgame-game-head", children: [
      /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("h3", { children: "\u5766\u514B\u5927\u6218" }),
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("p", { children: "\u65B9\u5411\u952E\u79FB\u52A8\uFF0C\u7A7A\u683C\u5F00\u70AE\uFF1B\u51FB\u6BC1\u654C\u65B9\u5766\u514B\uFF0C\u522B\u8BA9\u654C\u519B\u6467\u6BC1\u4E2D\u592E\u57FA\u5730\u3002" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "dgame-score", children: [
        /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("span", { children: [
          "\u5F97\u5206 ",
          /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("strong", { children: snap.score })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("span", { children: [
          "\u751F\u547D \xD7 ",
          player && player.lives
    ...
    /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "dgame-tank-stage", ref: stageRef, tabIndex: 0, role: "grid", onKeyDown, onKeyUp, onClick: () => focusStage(stageRef), "aria-label": "\u5766\u514B\u5927\u6218\u6E38\u620F\u533A\u57DF\uFF0C\u65B9\u5411\u952E\u79FB\u52A8\uFF0C\u7A7A\u683C\u5F00\u70AE", children: [
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "dgame-tank-grid", children: cells }),
      status === "over" ? /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "dgame-over", children: [
        /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("strong", { children: [
          "\u80DC\u8D25\u5DF2\u5206 \xB7 \u5F97 ",
          snap.score,
          " \u5206"
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("button", { type: "button", onClick: start, children: "\u91CD\u65B0\u5F00\u59CB" })
      ] }) : null,
      status === "wave" ? /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "dgame-over", children: [
        /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("strong", { children: [
          "\u7B2C ",
          snap.wave,
          " \u6CE2\u6E05\u7A7A\uFF01"
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("button", { type: "button", onClick: nextLvl, children: "\u4E0B\u4E00\u6CE2" })
      ] }) : null
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "dgame-controls dgame-tank-controls", children: [
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("button", { type: "button", "aria-label": "\u5411\u4E0A", onClick: () => {
        keys.current.dir = "up";
        setTimeout(() => {
          if (keys.current.dir === "up") keys.current.dir = null;
        }, 90);
      }, children: "\u2191" }),
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { children: "\u65B9\u5411\u952E / WASD \xB7 \u7A7A\u683C\u5F00\u70AE \xB7 R \u91CD\u5F00" }),
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("button", { type: "button", className: "dgame-tank-fire", "aria-label": "\u5F00\u70AE", onClick: () => {
        keys.current.shoot = true;
        setTimeout(() => {
...
function TankPreview() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { className: "dgcov-prev dgcov-prev-tank", "aria-hidden": "true", children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { className: "dgp-tank-grid", children: ROWS3.flatMap((row, r) => row.split("").map((ch, c) => /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("i", { className: "dgp-tank-" + cls[ch] }, r + "-" + c))) }) });
}
...
function useTaskPulse() {
  const [status, setStatus] = (0, import_react20.useState)({ loading: true, active: [], error: false });
  const refresh = (0, import_react20.useCallback)(() => fetch("/dsh-dock/animation/status", {
    method: "POST",
    headers: { "content-type": "application/json" },
    body: "{}"
...
function DashGame(props) {
  const [dash, setDash] = (0, import_react20.useState)(initialDash);
  const pausedRef = (0, import_react20.useRef)(!!(props && props.paused));
  pausedRef.current = !!(props && props.paused);
  const move = (0, import_react20.useCallback)((delta) => setDash((current) => Object.assign({}, current, {
    lane: Math.max(0, Math.min(LANES - 1, current.lane + delta))
  })), []);
  const stageRef = (0, import_react20.useRef)(null);
  ...
  for (let row = 0; row < 5; row += 1) {
    for (let lane = 0; lane < LANES; lane += 1) {
      ...
      cells.push(/* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("span", { className: "dgame-dash-cell", children: [
        rock ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("i", { className: "dgame-rock", children: "\u25C6" }) : null,
        pilot ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("b", { className: "dgame-pilot", children: "\u25B2" }) : null
      ] }, row + "-" + lane));
    }
  }
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("section", { className: "dgame-game", "aria-label": "\u661F\u9645\u8EB2\u907F\u5C0F\u6E38\u620F", children: [
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "dgame-game-head", children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("h3", { children: "\u661F\u9645\u8EB2\u907F" }),
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("p", { children: "\u5DE6\u53F3\u79FB\u52A8\u8865\u7ED9\u8247\uFF0C\u907F\u5F00\u6B63\u5728\u5760\u843D\u7684\u9668\u77F3\u3002" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "dgame-score", children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("span", { children: [
          "\u5F97\u5206 ",
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("strong", { children: dash.score })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("span", { "aria-label": "\u62A4\u76FE " + dash.shield + " \u683C", children: [
          "\u62A4\u76FE ",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "dgame-dash-stage", ref: stageRef, tabIndex: 0, onKeyDown, onClick: () => focusStage(stageRef), "aria-label": "\u661F\u9645\u8EB2\u907F\u6E38\u620F\u533A\u57DF\uFF0C\u4F7F\u7528\u5DE6\u53F3\u65B9\u5411\u952E\u6216\u4E0B\u65B9\u6309\u94AE\u79FB\u52A8", children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "dgame-dash-grid", children: cells }),
      !dash.running ? /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "dgame-over", children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("strong", { children: "\u62A4\u76FE\u8017\u5C3D" }),
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("button", { type: "button", onClick: () => setDash(initialDash()), children: "\u91CD\u65B0\u51FA\u53D1" })
      ] }) : null
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "dgame-controls", children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("button", { type: "button", "aria-label": "\u5411\u5DE6\u79FB\u52A8", onClick: () => move(-1), children: "\u2190 \u5DE6\u79FB" }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { children: "\u65B9\u5411\u952E / A\u3001D \xB7 \u7A7A\u683C\u91CD\u5F00" }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("button", { type: "button", "aria-label": "\u5411\u53F3\u79FB\u52A8", onClick: () => move(1), children: [
        "\u53F3\u79FB ",
        "->"
      ] })
    ] }),
...
function ReactorGame(props) {
  const [cells, setCells] = (0, import_react20.useState)(makeReactor);
  const [moves, setMoves] = (0, import_react20.useState)(0);
  const [cursor, setCursor] = (0, import_react20.useState)(4);
  const gridRef = (0, import_react20.useRef)(null);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("section", { className: "dgame-game", "aria-label": "\u53CD\u5E94\u5806\u70B9\u4EAE\u5C0F\u6E38\u620F", children: [
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "dgame-game-head", children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("h3", { children: "\u53CD\u5E94\u5806\u70B9\u4EAE" }),
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("p", { children: "\u70B9\u4E00\u4E0B\u4F1A\u5207\u6362\u76F8\u90BB\u6A21\u5757\uFF0C\u628A\u4E5D\u4E2A\u6A21\u5757\u5168\u90E8\u70B9\u4EAE\uFF1B\u952E\u76D8\uFF1A\u65B9\u5411\u952E\u9009\u683C\u3001Enter/\u7A7A\u683C \u70B9\u4EAE\u3001R \u91CD\u7F6E\u3002" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "dgame-score", children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("span", { children: [
          "\u64CD\u4F5C ",
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("strong", { children: moves })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("button", { type: "button", onClick: reset, children: "\u91CD\u7F6E" })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "dgame-reactor", ref: gridRef, tabIndex: 0, role: "group", "aria-label": "\u4E5D\u5BAB\u683C\u53CD\u5E94\u5806", onKeyDown, onClick: () => focusStage(gridRef), children: cells.map((on, index) => /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("button", { type: "button", tabIndex: -1, className: "dgame-reactor-cell" + (on ? " on" : "") + (cursor === index ? " focus" : ""), "aria-current": cursor === index ? "true" : void 0, "aria-label": (on ? "\u5DF2\u70B9\u4EAE" : "\u672A\u70B9\u4EAE") + "\u6A21\u5757 " + (index + 1), onClick: () => {
      toggle(index);
      setCursor(index);
      focusStage(gridRef);
    }, children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("i", {}) }, index)) }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "dgame-reactor-status" + (solved ? " solved" : ""), children: solved ? "\u53CD\u5E94\u5806\u7A33\u5B9A\u8FD0\u884C \xB7 \u505A\u5F97\u6F02\u4EAE\uFF08R \u91CD\u65B0\u5F00\u59CB\uFF09" : "\u8BA9\u6240\u6709\u6A21\u5757\u53D1\u5149\uFF0C\u7ED9\u4EFB\u52A1\u4E00\u70B9\u80FD\u91CF" })
  ] });
}
function DashCover() {
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("span", { className: "dgcov-prev dgcov-prev-dash", "aria-hidden": "true", children: [
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("i", {}),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("i", {}),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("i", {}),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("b", {})
  ] });
}
function ReactorCover() {
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: "dgcov-prev dgcov-prev-reactor", "aria-hidden": "true", children: Array.from({ length: 9 }, (_, i) => /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("i", {}, i)) });
}
var GAMES = [
  {
    id: "dash",
...
function useGameWin() {
  const [state, setState] = (0, import_react20.useState)(gamesBus.state);
  (0, import_react20.useEffect)(() => gamesBus.subscribe(() => setState(gamesBus.state)), []);
  return state;
}
var CATS = [
...
function GameCoverGrid(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "dgcov-groups", children: CATS.map((cat) => {
    const list = GAMES.filter((g) => (g.cat || "casual") === cat.id);
    if (!list.length) return null;
    return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "dgcov-section", children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "dgcov-sechead", children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("b", { children: cat.label }),
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { children: cat.desc }),
        /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("em", { children: [
          list.length,
          " \u6B3E"
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "dgcov-grid", role: "list", children: list.map((g) => /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(
        "button",
        {
          type: "button",
          role: "listitem",
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(g.Preview, {}),
            /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("span", { className: "dgcov-name", children: [
              /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("i", { style: { background: g.accent } }),
              g.name,
              /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("em", { children: currentId === g.id ? "\u6B63\u5728\u73A9" : "\u5F00\u73A9" })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: "dgcov-desc", children: g.desc })
          ]
        },
        g.id
      )) })
...
function TaskPill({ status }) {
  if (status.loading) return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: "dgwin-task", children: "\u6B63\u5728\u8BFB\u53D6\u4EFB\u52A1\u72B6\u6001\u2026" });
  const task = status.active[0];
  if (!task) return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("span", { className: "dgwin-task idle", children: [
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("i", {}),
    "\u4EFB\u52A1\u7A7A\u95F2 \xB7 \u6162\u6162\u73A9"
  ] });
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("span", { className: "dgwin-task live", children: [
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("i", {}),
...
function GameWindow(props) {
  ...
  const [win, setWin] = (0, import_react20.useState)(() => typeof window === "undefined" ? { mode: "normal", x: 14, y: 14, w: 470, h: 600 } : restoreWinGeom());
  const winRef = (0, import_react20.useRef)(win);
  winRef.current = win;
  const pickerRef = (0, import_react20.useRef)(props.picker);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "dgwin dgwin-" + win.mode, role: "dialog", "aria-label": "\u6E38\u620F\u7A97\u53E3\uFF1A" + (game ? game.name : "\u8DA3\u5473\u6E38\u620F"), style, children: [
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(
      "header",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: "dgwin-ico", children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(GamepadIcon, { size: 15 }) }),
          /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "dgwin-title", children: [
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("b", { children: game ? game.name : "\u8DA3\u5473\u6E38\u620F" }),
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { children: game ? game.desc : "\u9009\u4E00\u6B3E\u5C0F\u6E38\u620F\uFF0C\u8FB9\u7B49\u8FB9\u73A9" })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(TaskPill, { status }),
          /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "dgwin-ctrls", children: [
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("button", { type: "button", className: "dgwin-btn", title: props.picker ? "\u6536\u8D77\u9009\u62E9\u5C42\uFF0C\u56DE\u5230\u6E38\u620F" : "\u5C55\u5F00\u9009\u62E9\u5C42\uFF0C\u6362\u4E00\u6B3E\u6E38\u620F", onClick: () => gamesBus.togglePicker(), children: props.picker ? "\u8FD4\u56DE" : "\u6362\u6E38\u620F" }),
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("button", { type: "button", className: "dgwin-sq", title: win.mode === "min" ? "\u8FD8\u539F" : "\u6700\u5C0F\u5316", "aria-label": win.mode === "min" ? "\u8FD8\u539F\u7A97\u53E3" : "\u6700\u5C0F\u5316\u7A97\u53E3", onClick: () => setWin((s) => Object.assign({}, s, { mode: s.mode === "min" ? "normal" : "min" })), children: "\u2581" }),
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("button", { type: "button", className: "dgwin-sq", title: win.mode === "max" ? "\u8FD8\u539F" : "\u6700\u5927\u5316", "aria-label": win.mode === "max" ? "\u8FD8\u539F\u7A97\u53E3" : "\u6700\u5927\u5316\u7A97\u53E3", onClick: () => setWin((s) => Object.assign({}, s, { mode: s.mode === "max" ? "normal" : "max" })), children: win.mode === "max" ? "\u2750" : "\u25A2" }),
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("button", { type: "button", className: "dgwin-sq", title: "\u5173\u95ED\uFF08Esc\uFF09", "aria-label": "\u5173\u95ED\u6E38\u620F\u7A97\u53E3", onClick: () => gamesBus.close(), children: "\u2715" })
          ] })
        ]
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "dgwin-body", children: [
      Game ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Game, { paused: props.picker || win.mode === "min" }) : /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "dgwin-empty", children: "\u4ECE\u300C\u6362\u6E38\u620F\u300D\u91CC\u6311\u4E00\u6B3E\u5F00\u59CB\u73A9\u3002" }),
      game ? /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("footer", { className: "dgwin-tip", children: [
        game.tip,
        " \xB7 Esc \u5173\u95ED\u7A97\u53E3"
      ] }) : null,
      props.picker ? /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "dgwin-picker", role: "dialog", "aria-label": "\u9009\u62E9\u5C0F\u6E38\u620F", children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "dgwin-picker-head", children: [
          /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("b", { children: "\u9009\u62E9\u5C0F\u6E38\u620F" }),
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { children: "\u70B9\u51FB\u5C01\u9762\u5F00\u73A9\uFF1B\u7A97\u53E3\u4F4D\u7F6E\u548C\u5927\u5C0F\u968F\u4F60\u8C03" })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("button", { type: "button", className: "dgwin-picker-close", "aria-label": "\u5173\u95ED\u9009\u62E9\u5C42", title: "\u5173\u95ED", onClick: () => gamesBus.closePicker(), children: "\u2715" })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(GameCoverGrid, { currentId: game && game.id, onLaunch: (id) => gamesBus.launch(id) })
      ] }) : null
    ] }),
    win.mode === "normal" ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "dgwin-resize", title: "\u62D6\u52A8\u8C03\u6574\u7A97\u53E3\u5927\u5C0F", "aria-hidden": "true", onPointerDown: (e) => beginDrag(e, "size") }) : null
  ] });
}
function GameFab(props) {
  ...
  const clickBlockRef = (0, import_react20.useRef)(false);
  const sideRef = (0, import_react20.useRef)("left");
  (0, import_react20.useEffect)(() => {
    if (typeof window === "undefined") return;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: "dgfab-ico", children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(GamepadIcon, { size: 16 }) }),
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: "dgfab-label", children: "\u8DA3\u5473\u6E38\u620F" })
      ]
    }
  );
}
function GamepadIcon(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("svg", { width: size, height: size, viewBox: "0 0 16 16", fill: "none", stroke: "currentColor", strokeWidth: "1.3", "aria-hidden": "true", children: [
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("rect", { x: "1.6", y: "4.6", width: "12.8", height: "6.8", rx: "3.2" }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("path", { d: "M4.7 6.8v2.6M3.4 8.1h2.6" }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("circle", { cx: "10.4", cy: "6.9", r: ".95", fill: "currentColor", stroke: "none" }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("circle", { cx: "12.2", cy: "8.7", r: ".95", fill: "currentColor", stroke: "none" })
  ] });
}
function GamesOverlay() {
  const winState = useGameWin();
  const [panelOpen, setPanelOpen2] = (0, import_react20.useState)(panelNav.open);
  (0, import_react20.useEffect)(() => {
    setPanelOpen2(panelNav.open);
    return subscribePanel(() => setPanelOpen2(panelNav.open));
  }, []);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(import_jsx_runtime13.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(GameFab, { hidden: winState.open || panelOpen }),
    winState.open ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(GameWindow, { game, picker: winState.picker }) : null
  ] });
}
function TaskStatus({ status }) {
  const task = status.active[0];
  if (status.loading) return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "dgame-task-status loading", children: "\u6B63\u5728\u8BFB\u53D6\u4EFB\u52A1\u72B6\u6001\u2026" });
  if (!task) return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "dgame-task-status", children: [
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("i", {}),
    " \u4EFB\u52A1\u6682\u65F6\u7A7A\u95F2 \xB7 \u6E38\u620F\u968F\u65F6\u53EF\u73A9"
  ] });
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "dgame-task-status live", children: [
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("i", {}),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("span", { title: task.title, children: [
        task.title || "\u5F53\u524D\u4EFB\u52A1",
        " \xB7 \u5DF2\u8FD0\u884C ",
        elapsedText(task.elapsed)
      ] })
...
function GamesView() {
  const status = useTaskPulse();
  const winState = useGameWin();
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("section", { className: "dgame", children: [
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("header", { className: "dgame-hero", children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("span", { className: "dgame-eyebrow", children: [
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("i", {}),
          " \u7B49\u5F85\u4E5F\u53EF\u4EE5\u5F88\u597D\u73A9"
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("h2", { children: "\u8DA3\u5473\u6E38\u620F" }),
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("p", { children: "\u4EFB\u52A1\u5728\u540E\u53F0\u7EE7\u7EED\u6267\u884C\uFF1B\u6E38\u620F\u5728\u5C40\u90E8\u6D6E\u52A8\u7A97\u53E3\u91CC\u8FD0\u884C\uFF0C\u4E0D\u94FA\u6EE1\u5168\u5C4F\u3001\u4E0D\u906E\u6321\u4F1A\u8BDD\u5185\u5BB9\uFF0C\u4E5F\u4E0D\u5F71\u54CD\u6587\u4EF6\u6216\u6B63\u5728\u8FD0\u884C\u7684\u667A\u80FD\u4F53\u3002" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("span", { className: "dgame-planet", "aria-hidden": "true", children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("i", {}),
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("b", {})
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(TaskStatus, { status }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "dgame-launch-note", children: "\u70B9\u51FB\u5C01\u9762\u5728\u6D6E\u52A8\u7A97\u53E3\u5F00\u73A9\uFF1A\u7A97\u53E3\u53EF\u62D6\u52A8\u3001\u53EF\u8C03\u5927\u5C0F\u3001\u53EF\u6700\u5927\u5316\u6700\u5C0F\u5316\uFF1B\u5C4F\u5E55\u4FA7\u8FB9\u7684\u300C\u8DA3\u5473\u6E38\u620F\u300D\u78C1\u5438\u5165\u53E3\u8D34\u5728\u5DE6\u4FA7\u8FB9\u680F\u53F3\u7F18\uFF08\u4E0D\u6321\u5DE5\u4F5C\u533A\u76EE\u5F55\uFF09\uFF0C\u53EF\u4E0A\u4E0B\u632A\u4F4D\u3001\u5DE6\u53F3\u6362\u8FB9\uFF0C\u4F4D\u7F6E\u90FD\u4F1A\u8BB0\u4F4F\uFF1B\u5341\u6B3E\u5C0F\u6E38\u620F\u90FD\u652F\u6301\u952E\u76D8\uFF08\u80FD\u914D\u6309\u94AE\u7684\u4E5F\u914D\u4E86\u6309\u94AE\uFF09\u64CD\u4F5C\u3002" }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(GameCoverGrid, { currentId: winState.open ? winState.game : null, onLaunch: (id) => {
      gamesBus.launch(id);
      setPanelOpen(false);
    } }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("footer", { className: "dgame-foot", children: "\u6E38\u620F\u4E2D\u6309 Esc \u5173\u95ED\u7A97\u53E3\uFF1B\u6E38\u620F\u4E0D\u53D1\u9001\u4EFB\u4F55\u6D88\u606F\uFF0C\u4E5F\u4E0D\u6539\u52A8\u5DE5\u4F5C\u533A\u3002\u65B9\u5411\u952E / WASD\u3001Enter\u3001\u7A7A\u683C\u3001R\u3001U\u3001P \u7B49\u952E\u968F\u6E38\u620F\u53EF\u7528\uFF1B\u4E94\u5B50\u68CB\u3001\u8C61\u68CB\u652F\u6301\u64A4\u9500/\u91CD\u5F00\u3002" })
  ] });
}
function GamesHomeStat() {
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { children: "\u5341\u6B3E\u6D6E\u52A8\u7A97\u53E3\u5C0F\u6E38\u620F \xB7 \u4E94\u5B50\u68CB/\u8C61\u68CB/\u4FC4\u7F57\u65AF\u65B9\u5757/\u63A8\u7BB1\u5B50\u2026\u4EFB\u52A1\u7B49\u5F85\u4E0D\u65E0\u804A" });
}
var baseCss = `
...
`;
var css5 = [baseCss, tetrisGame.css, sokobanGame.css, gomokuGame.css, xiangqiGame.css, snakeGame.css, breakoutGame.css, racerGame.css, tankGame.css, dgcovGroupCss].filter(Boolean).join("\n");
var feature9 = {
  id: "games",
  name: "\u8DA3\u5473\u6E38\u620F",
  order: 135,
...
function RelayIcon({ name, size = 18 }) {
  ...
  if (name === "link") return /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("svg", { ...common, children: [
    /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("path", { d: "M10.5 13.5a4 4 0 0 0 5.66.01l2-2a4 4 0 0 0-5.66-5.66l-1.15 1.14" }),
    /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("path", { d: "M13.5 10.5a4 4 0 0 0-5.66-.01l-2 2a4 4 0 0 0 5.66 5.66l1.15-1.14" })
  ] });
  if (name === "copy") return /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("svg", { ...common, children: [
    /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("rect", { x: "8", y: "8", width: "11", height: "12", rx: "1.5" }),
    /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("path", { d: "M16 8V5.5A1.5 1.5 0 0 0 14.5 4h-9A1.5 1.5 0 0 0 4 5.5v9A1.5 1.5 0 0 0 5.5 16H8" })
  ] });
  if (name === "close") return /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("svg", { ...common, children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("path", { d: "m6 6 12 12M18 6 6 18" }) });
  if (name === "check") return /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("svg", { ...common, children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("path", { d: "m5 12 4.2 4.2L19 6.5" }) });
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("svg", { ...common, children: [
    /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("circle", { cx: "12", cy: "12", r: "8" }),
    /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("path", { d: "M12 8v4l2.5 2" })
  ] });
}
function useCompact() {
  const [compact, setCompact] = (0, import_react21.useState)(() => typeof window !== "undefined" && window.matchMedia("(max-width: 680px)").matches);
...
function RemoteCard() {
  ...
  const [lan, setLan] = (0, import_react21.useState)(null);
  const [username, setUsername] = (0, import_react21.useState)("");
  const [password, setPassword] = (0, import_react21.useState)("");
  const [newPassword, setNewPassword] = (0, import_react21.useState)("");
  const [port, setPort] = (0, import_react21.useState)("");
  const [address, setAddress] = (0, import_react21.useState)("");
  const [qr, setQr] = (0, import_react21.useState)("");
  const [busy, setBusy] = (0, import_react21.useState)("");
  const [message, setMessage] = (0, import_react21.useState)("");
  const [messageKind, setMessageKind] = (0, import_react21.useState)("error");
  const [changing, setChanging] = (0, import_react21.useState)(false);
  const [remote, setRemote] = (0, import_react21.useState)(false);
  const notify = (0, import_react21.useCallback)((text, kind) => {
    setMessage(text);
  ...
  const lanLink = (0, import_react21.useMemo)(() => address && active ? "http://" + address + ":" + gatewayPort : "", [address, active, gatewayPort]);
  (0, import_react21.useEffect)(() => {
    let live = true;
    if (!lanLink) {
      setQr("");
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("section", { className: "dmr " + (compact ? "dmr-compact" : ""), children: [
    /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "dmr-status-head", children: [
      /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("span", { className: "dmr-eyebrow", children: [
          /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("i", {}),
          " \u8FDC\u7A0B\u8BBF\u95EE"
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("h3", { children: active ? "\u5165\u53E3\u5DF2\u5F00\u542F" : "\u4ECE\u4EFB\u4F55\u8BBE\u5907\u8BBF\u95EE\u8FD9\u4E2A DSH" }),
        /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("p", { children: active ? "\u8BBE\u5907\u8BBF\u95EE\u4E0B\u65B9\u5730\u5740\uFF0C\u7528\u8D26\u53F7\u5BC6\u7801\u767B\u5F55\u5373\u53EF\u4F7F\u7528\u5B8C\u6574 DSH\uFF08\u4E0E\u672C\u673A\u540C\u4E00\u5B9E\u4F8B\uFF0C\u4EFB\u52A1\u8FDB\u5EA6\u5B9E\u65F6\u4E00\u81F4\uFF09\u3002" : "\u5F00\u542F\u540E\uFF0C\u5C40\u57DF\u7F51/\u865A\u62DF\u7F51\u8BBE\u5907\u8BBF\u95EE\u7F51\u5173\u5730\u5740\u5E76\u767B\u5F55\uFF0C\u5373\u53EF\u4F7F\u7528\u4E0E\u672C\u673A\u5B8C\u5168\u4E00\u81F4\u7684 DSH\u3002" })
      ] }),
      remote && /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("button", { type: "button", className: "dmr-secondary", onClick: logout, children: [
        /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(RelayIcon, { name: "close" }),
        "\u9000\u51FA\u767B\u5F55"
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("ol", { className: "dmr-steps", children: [
      /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("li", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("span", { children: "1" }),
        /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("strong", { children: "\u8BBE\u7F6E\u8D26\u53F7\u5BC6\u7801" }),
          /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("small", { children: "\u8FDC\u7A0B\u767B\u5F55\u7684\u552F\u4E00\u51ED\u636E\uFF0C\u6539\u5BC6\u540E\u6240\u6709\u8BBE\u5907\u91CD\u65B0\u767B\u5F55\u3002" })
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("li", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("span", { children: "2" }),
        /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("strong", { children: "\u5F00\u542F\u5165\u53E3" }),
          /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("small", { children: "\u7F51\u5173\u76D1\u542C 0.0.0.0\uFF08\u9ED8\u8BA4\u4E3B\u7AEF\u53E3+1\uFF0C\u53EF\u6539\uFF09\uFF0C\u4E3B\u5B9E\u4F8B\u4FDD\u6301\u4EC5\u672C\u673A\u3002" })
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("li", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("span", { children: "3" }),
        /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("strong", { children: "\u8BBE\u5907\u8BBF\u95EE" }),
          /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("small", { children: "\u626B\u7801\u6216\u8F93\u5165\u5730\u5740\u767B\u5F55\uFF1B\u5F02\u5730\u7EC4\u7F51\uFF08Tailscale \u7B49\uFF09\u7528\u7EC4\u7F51 IP \u76F4\u8FDE\u3002" })
        ] })
      ] })
    ] }),
    !active ? /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "dmr-network-grid", children: [
      /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("label", { className: "dmr-field", children: [
        /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("span", { children: "\u8D26\u53F7" }),
        /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("input", { value: username, onChange: (e) => setUsername(e.target.value), autoComplete: "username", placeholder: "\u767B\u5F55\u8D26\u53F7" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("label", { className: "dmr-field", children: [
        /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("span", { children: "\u5BC6\u7801" }),
        /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("input", { type: "password", value: password, onChange: (e) => setPassword(e.target.value), autoComplete: "new-password", placeholder: lan && lan.accountSet ? "\u5DF2\u8BBE\u7F6E\uFF0C\u7559\u7A7A\u6CBF\u7528" : "\u81F3\u5C11 6 \u4F4D" })
      ] })
    ] }) : null,
    /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "dmr-network-grid", children: [
      /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("label", { className: "dmr-field", children: [
        /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("span", { children: "\u76D1\u542C\u7AEF\u53E3" }),
        /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("input", { value: port, onChange: (e) => setPort(e.target.value), inputMode: "numeric", type: "number", min: "1024", max: "65535", placeholder: "\u9ED8\u8BA4 " + suggestedPort, "aria-describedby": "dmr-lan-port-help" }),
        /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("small", { id: "dmr-lan-port-help", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "dmr-security", children: [
        /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("strong", { children: "\u5B89\u5168\u8BF4\u660E" }),
        /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("p", { children: "\u4E3B\u5B9E\u4F8B\u4FDD\u6301\u4EC5\u76D1\u542C 127.0.0.1\uFF1A\u8FDC\u7A0B\u8BBE\u5907\u53EA\u80FD\u7ECF\u8FD9\u4E2A\u767B\u5F55\u7F51\u5173\u8FDB\u5165\uFF0C\u4E0D\u5B58\u5728\u514D\u767B\u5F55\u7684\u76F4\u8FDE\u8DEF\u5F84\u3002\u8D26\u53F7\u5BC6\u7801\u53EA\u53D1\u7ED9\u81EA\u5DF1\uFF1B\u6539\u5BC6\u540E\u6240\u6709\u8BBE\u5907\u9700\u91CD\u65B0\u767B\u5F55\u3002" })
      ] })
    ] }),
    active ? /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("div", { className: "dmr-share", children: /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "dmr-share-layout", children: [
      /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "dmr-qr-card", children: [
        qr ? /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("img", { src: qr, alt: "\u8FDC\u7A0B\u8BBF\u95EE\u5730\u5740\u4E8C\u7EF4\u7801", width: "220", height: "220" }) : /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("div", { className: "dmr-qr-loading", children: "\u6B63\u5728\u751F\u6210\u4E8C\u7EF4\u7801\u2026" }),
        /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("strong", { children: "\u626B\u7801\u6216\u8F93\u5165\u5730\u5740" }),
        /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("small", { children: "\u6253\u5F00\u540E\u8F93\u5165\u8D26\u53F7\u5BC6\u7801\u767B\u5F55" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "dmr-share-detail", children: [
        /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("span", { className: "dmr-eyebrow", children: [
            /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("i", {}),
            " \u767B\u5F55\u7F51\u5173\u5DF2\u8FD0\u884C"
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("h4", { children: lanLink })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("div", { className: "dmr-link", title: lanLink, children: lanLink }),
        /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "dmr-share-actions", children: [
          /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("button", { type: "button", className: "dmr-primary", onClick: copyLink, disabled: !lanLink, children: [
            /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(RelayIcon, { name: "copy" }),
            "\u590D\u5236\u5730\u5740"
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("button", { type: "button", className: "dmr-secondary dmr-danger", onClick: disable, disabled: busy === "stop", children: [
            /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(RelayIcon, { name: "close" }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(RelayIcon, { name: "link" }),
      "\u5F00\u542F\u8FDC\u7A0B\u8BBF\u95EE"
    ] }) }),
    active ? /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "dmr-section", children: [
      /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "dmr-section-head", children: [
        /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("h4", { children: "\u4FEE\u6539\u8D26\u53F7\u5BC6\u7801" }),
        /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("button", { type: "button", className: "dmr-text-button", onClick: () => setChanging((v) => !v), children: changing ? "\u6536\u8D77" : "\u4FEE\u6539" })
      ] }),
      changing ? /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "dmr-note", children: [
        /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "dmr-network-grid", children: [
          /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("label", { className: "dmr-field", children: [
            /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("span", { children: "\u8D26\u53F7" }),
            /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("input", { value: username, onChange: (e) => setUsername(e.target.value), autoComplete: "username" })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("label", { className: "dmr-field", children: [
            /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("span", { children: "\u65B0\u5BC6\u7801" }),
            /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("input", { type: "password", value: newPassword, onChange: (e) => setNewPassword(e.target.value), autoComplete: "new-password", placeholder: "\u81F3\u5C11 6 \u4F4D" })
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("button", { type: "button", className: "dmr-secondary", onClick: saveAuth, disabled: busy === "auth" || !username.trim() || newPassword.length < 6, children: busy === "auth" ? "\u4FDD\u5B58\u4E2D\u2026" : "\u4FDD\u5B58\uFF08\u6240\u6709\u8BBE\u5907\u91CD\u65B0\u767B\u5F55\uFF09" })
      ] }) : /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("p", { className: "dmr-note", children: [
        "\u5F53\u524D\u8D26\u53F7\uFF1A",
        lan.username || "\u2014",
        "\u3002\u4FEE\u6539\u540E\u6240\u6709\u5DF2\u767B\u5F55\u8BBE\u5907\u5C06\u88AB\u5F3A\u5236\u9000\u51FA\u3002"
      ] })
    ] }) : null,
    message ? /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("div", { className: "dmr-message " + (messageKind === "success" ? "success" : "error"), role: "alert", children: message }) : null
  ] });
}
function MobileRelayView() {
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(RemoteCard, {});
}
function MobileRelayOverlay() {
  (0, import_react21.useEffect)(() => {
    ...
    const expand = () => {
      const b = document.querySelector('button[aria-label="\u6253\u5F00\u4FA7\u8FB9\u680F"],button[aria-label="Open sidebar"]');
      if (b) b.click();
    };
    const closeDetails = () => {
