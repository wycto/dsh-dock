...
| **任务动画** | 任务运行动画（流光细线 / 呼吸光点 / 轨道光环 / 环屏巡航 / 代码雨 / 星野 / 极光 / 桌面伙伴 3D 场景，共 8 种氛围模式）与完成通知（通知音、浏览器系统通知、钉钉/飞书群机器人推送），动画、通知两组开关独立，配置全部持久化 |
...
![任务动画设置页：8 种氛围模式、新版双工位桌面伙伴与大小控制](screenshots/dock-animation.png)
