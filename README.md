...
| **任务动画** | 任务运行动画（流光细线 / 呼吸光点 / 轨道光环 / 环屏巡航 / 代码雨 / 星野 / 极光 / 桌面伙伴 3D 场景，共 8 种氛围模式）与完成通知（通知音、浏览器系统通知、钉钉群机器人推送），动画、通知两组开关独立，配置全部持久化 |
...
4. 所有配置（动画开关 / 动画模式 / 桌面伙伴大小 / 通知各项 / 提示音 / 钉钉 Webhook）经宿主 settings 持久化，重启 dsh 后自动恢复
